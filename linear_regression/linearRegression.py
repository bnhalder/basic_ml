...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug 19 23:13:06 2017
...
x = data[:, 0]
y = data[:, 1]
print("Number of Invalid Entries: %i" % sp.sum(sp.isnan(y)))
x = x[~sp.isnan(y)]
y = y[~sp.isnan(y)]
...
plot_models(x, y, [f1, f2, f10, f100], os.path.join(CHART_DIR, "1400_01_04.png"))

#fit and polt the model using the knowldge about inflection point
...
for f in [fbt1, fbt2, fbt3, fbt10, fbt100]:
    print("Error for d=%i: %f"%(f.order, error(f, x[test], y[test])))
