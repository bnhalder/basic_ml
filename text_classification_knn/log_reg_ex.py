...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 25 17:03:27 2017
...
X = np.hstack((norm.rvs(2, size=num_per_class, scale=2),
               norm.rvs(3, size=num_per_class, scale=3)))
...
print(linclf)
linclf.fit(X.reshape(2*num_per_class, 1), y)
pyplot.figure(figsize=(10, 4))
pyplot.subplot(1, 2, 1)
pyplot.scatter(X, y, c=y)
pyplot.plot(X_test, lin_model(linclf, X_test))
pyplot.xlabel("feature value")
pyplot.ylabel("class")
