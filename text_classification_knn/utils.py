...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 24 16:34:31 2017
...
def fetch_data(filename, col=None, line_count=-1, only_questions=False):
    ...
    for line in open(filename, 'r'):
        count += 1
        if line_count > 0 and count > line_count: break
...
def load_meta(filename):
    ...
    for key in keys:
        ...
        del meta[key]
    # post_id to index in vectorized
    id_to_idx = {}
    # and back
    idx_to_id = {}
...
def show_most_informative_feature(vectorizer, clf, name, n=20):
