...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 25 11:47:12 2017
...
prepare_sent_feature()

def get_feature(aid):
    return tuple(meta[aid][fn] for fn in feature_names)

qa_X = np.asarray([get_feature(aid) for aid in all_answers])
...
if classifying_answer == "good":
    ...
    raise Exception("classifying_answer='%s' is not supported" % classifying_answer)
