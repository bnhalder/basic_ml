...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 24 12:47:28 2017
...
filename_filtered_meta = os.path.join(DATA_DIR, "filtered_meta.json")
print("Meta: %s" % filename_filtered_meta)

q_creation = {} #creation datetime of questions
q_accepted = {} #id of accepted answer

#question -> [(answer_id, isAccepted, TimeToAnswer, Score), ...]
...
def filter_html(s):
    ...
    #remove source code and count no of lines
