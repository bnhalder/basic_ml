...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 22 12:10:52 2017
...
def plot_decision(features, labels, num_neighbours = 1):
    ...
    if COLOR_FIGURE:
        ...
        for lab, ma in zip(range(3), "Do^"):
            ax.plot(features[labels == lab, 0], features[labels == lab, 2], 
                    ma, c = (1., 1., 1.), ms = 6)
...
fig.tight_layout()
fig.savefig('figure4_sklearn.png')

features -= features.mean(0)
features /= features.std(0)
fig, ax = plot_decision(features, labels)
fig.tight_layout()
fig.savefig('figure5_sklearn.png')

fig, ax = plot_decision(features, labels, 11)
fig.tight_layout()
fig.savefig('figure5_sklearn_11neighbours.png')
